    ...
    <section id='contact' className='scroll-mt-12'>
      <div className='container'>
        <div className='relative'>
          <h2 className='mb-9 text-midnight_text'>Hubungi Kami</h2>
            ...
            <form
              ...
              <div className='sm:flex gap-6 w-full'>
                ...
                <div className='mx-0 my-2.5 flex-1'>
                  ...
                  <input
                    ...
                    type='tel'
                    name='phnumber'
                    placeholder='Masukkan nomor telphone anda'
              ...
              <div className='mx-0 my-2.5 w-full'>
                <button
                  ...
                  className={`border leading-none px-6 text-lg font-medium py-4 rounded-4xl transition-all duration-500
                    ${
                      !isFormValid || loader
